...
class Admin{
    ...
    static async getModerationList(){
        try {
            ...
            const text =
             `
            SELECT ar.id, f.id as "forum_id",a.id as "alumni_id",f.title, ar.author_name, ar.reporter_name, ar.description, a.report_warnings, a.banned
   ...
   static async skipReport(id){
    try {
        //Text
        const text = `DELETE from alumni_report WHERE id=$1 `
